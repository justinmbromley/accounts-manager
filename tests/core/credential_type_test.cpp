...
void CredentialTypeTest::credential_type_to_string_test() {
    ...
    QCOMPARE(core::credential_type_to_string(core::CredentialType::SecretQA), QString("SECRET_QA"));
...
void CredentialTypeTest::credential_type_from_string_test() {
    ...
    QCOMPARE(core::credential_type_from_string("SECRET_QA"), core::CredentialType::SecretQA);
